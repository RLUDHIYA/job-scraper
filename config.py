...
LINKEDIN_SEARCH_QUERIES = ["Data Analyst", "Junior Data Scientist", "Business Intelligence Analyst", "Machine Learning Engineer (Entry Level)", "Data Engineer (Graduate/Junior)"]
...
CAREERS_FUTURE_SEARCH_QUERIES = ["Data Analyst", "Data Scientist (Entry Level)", "Business Intelligence Analyst", "Machine Learning Engineer", "Data Engineer (Junior/Associate)"]
